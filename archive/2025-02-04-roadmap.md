...
The main activities are:
  ...
  - **Take a stab at metrics and test+document log failover**
    - TODO(@ln5,rgdd): milestone / placeholder issues
    - Work and review by: elias, ln5
  ...
  - **Dogfood use of Sigsum as a building block in ST**
    - Relates to: priority (3)
    - Work and review by: nisse, rgdd
    - Expected done: undefined, expected outcome is to contribute some
  ...
  - **Continue to explore the "shared configuration" ideas**.
    ...
    - Expected done: undefined, the next step is to continue the on-and-off
      discussions with Google's Trust Fabric team.
    - (For some context, see [these notes][].)
...
## People and their standing responsibilities
  ...
  - rgdd
    ...
    - Point of contact for logs and witnesses that would like user support (TODO: should this be ln5?)

TODO(@ln5): nisse suggests glasklar log/witness ops to be listed here. Yes or no?
