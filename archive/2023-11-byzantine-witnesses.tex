...
\begin{equation}
  k_2 = n - \floor{k_1/2}
\end{equation}
This give a family of reasonable pairs of policy and dual policy, like
\centerline{
  \begin{tabular}{lll}
...
Maybe this is good enough to document and apply automatically when
monitoring, to not require users to specify $f$ explicitly?
