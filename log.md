...
**Table of contents:**
  ...
  1.  [Introduction](#1-introduction)
      1.  [Objective and Threat Model](#11-objective-and-threat-model)
      2.  [System Overview](#12-system-overview)
      3.  [Companion Specifications](#13-companion-specifications)
  2.  [Algorithms and Formats](#2-algorithms-and-formats)
      1.  [Cryptography](#21-cryptography)
  ...
  3.  [HTTP Endpoints](#3-http-endpoints)
      ...
      3.  [get-consistency-proof](#33-get-consistency-proof)
      4.  [get-leaves](#34-get-leaves)
      5.  [add-leaf](#35-add-leaf)
  4.  [Rate Limiting](#4-rate-limiting)
      1.  [Setup](#41-setup)
      2.  [Request Header](#42-request-header)
      3.  [Security Considerations](#43-security-considerations)
...
A _sigsum log_ publishes signed checksums.  Together with other parties
in the sigsum system (so called _witnesses_ and _monitors_), this makes
it difficult for attackers to perform undetected signature operations.
...
values exceeding 63 bits in size are not allowed.  This range, rather
...
short summary.  Some status code are documented further for each
